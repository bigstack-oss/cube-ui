...
describe('addCubeUiTranslations', () => {
  it('overrides an existing key for a locale @bigstack-oss/cube-ui already ships', () => {
  ...
  it('rejects an unknown/misspelled key at compile time', () => {
    // @ts-expect-error - 'component.common.laoding' is not a valid @bigstack-oss/cube-ui translation key.
